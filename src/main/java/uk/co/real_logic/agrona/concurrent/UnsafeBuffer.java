...
public class UnsafeBuffer implements AtomicBuffer
{
    ...
    private static void boundsCheck(final byte[] buffer, final long index, final int length)
    {
    ...
    private static void boundsCheck(final ByteBuffer buffer, final long index, final int length)
    {
